            ...
            <div class="nav-content">
                ...
                <div class="relative" id="help-menu-container">
                    ...
                    <div id="contact-info" class="contact-popup">
                        <h4 class="font-bold text-slate-100 mb-2">Hubungi Saya</h4>
                        <p class="text-sm text-slate-300">Punya pertanyaan atau masukan?</p>
                        <a href="mailto:hello@syalva.id" class="text-sm text-sky-400 block mt-2 hover:underline">hello@syalva.id</a>
                    </div>
                </div>
            </div>
        </nav>
